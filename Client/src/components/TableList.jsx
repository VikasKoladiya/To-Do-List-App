...
function TableList({ handleOpen, tableData, setTableData , searchTerm}) {
                ...
                <tbody className="hover">
                    {/* row 1 */}
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <button onClick={() => handleOpen('edit', data)} className="btn btn-secondary">Update</button>
                            </td>
                            <td>
                                <button className="btn btn-accent"  onClick={() => handleDelete(data.id)}>Delete</button>
                            </td>
                        </tr>
                    ))}
